...
public class ReviewRepository {
	...
	public ReviewRepository() {
		...
		Review guitarWolf = new Review(1111L, "Guitar Wolf", "/images/guitarwolf.jpg", "Japanese Punk Rock",
				"Guitar Wolf is a Japanese garage rock power trio founded in Nagasaki in 1987. The band is known for songs with piercing vocals and an extremely loud style of noise-influenced punk which emphasizes heavy distortion and feedback. ");
